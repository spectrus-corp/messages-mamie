...
function uploadAudio(id, input) {
  ...
  const allowedTypes = ['audio/mp3', 'audio/mpeg', 'audio/mp4', 'audio/x-m4a', 'audio/wav'];
  ...
  reader.onload = function(e) {
    ...
    localStorage.setItem(`audio_${id}`, audioData);
    
    // Message propre
    alert(`✅ Fichier "${id}" mis à jour avec succès !`);
    
    // Optionnel : recharger l'interface
    showMainInterface();
  };
